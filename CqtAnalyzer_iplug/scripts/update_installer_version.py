...
# WIN INSTALLER
  ...
  for line in fileinput.input(projectpath + "/installer/" + config['BUNDLE_NAME'] + ".iss",inplace=1):
    ...
    if "OutputBaseFilename" in line:
      if demo:
        line="OutputBaseFilename=CqtAnalyzer Demo Installer\n"
      else:
        line="OutputBaseFilename=CqtAnalyzer Installer\n"
    ...
    if "WelcomeLabel1" in line:
     if demo:
       line="WelcomeLabel1=Welcome to the CqtAnalyzer Demo installer\n"
     else:
       line="WelcomeLabel1=Welcome to the CqtAnalyzer installer\n"
       
    if "SetupWindowTitle" in line:
     if demo:
       line="SetupWindowTitle=CqtAnalyzer Demo installer\n"
     else:
       line="SetupWindowTitle=CqtAnalyzer installer\n"
