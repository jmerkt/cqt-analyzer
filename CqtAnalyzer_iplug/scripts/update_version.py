...
def main():
  ...
  plistpath = scriptpath + "/resources/CqtAnalyzer-VST2-Info.plist"
  ...
  plistpath = scriptpath + "/resources/CqtAnalyzer-AU-Info.plist"
  ...
  plistpath = scriptpath + "/resources/CqtAnalyzer-VST3-Info.plist"
  ...
  plistpath = scriptpath + "/resources/CqtAnalyzer-macOS-Info.plist"
  ...
  plistpath = scriptpath + "/resources/CqtAnalyzer-AAX-Info.plist"
  ...
  plistpath = scriptpath + "/installer/CqtAnalyzer.pkgproj"
  ...
  for line in fileinput.input(scriptpath + "/installer/CqtAnalyzer.iss",inplace=1):
